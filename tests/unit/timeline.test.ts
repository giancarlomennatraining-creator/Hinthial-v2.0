...
describe("buildTimeline", () => {
  it("includes one entry per document/asset/reminder/friend/capsule", () => {
    const context = buildContext({
      ...
      friends: [
        { id: "friend-1", name: "Maria", email: "m@x.it", firstName: "", lastName: "", avatarPath: null, avatarUrl: null, role: "Coniuge", status: "active", isFriend: false, isGuardian: false, linkedUserId: null, createdAt: "2026-04-01" },
      ],
      capsules: [
        {
          id: "capsule-1",
